...
<body>
  <div>
      ...
      <tbody>
        ...
        ${printExtras.map(e => `
          <tr>
            ...
            <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: center; color: #0284c7; font-weight: 600;">Relación de Adicionales</td>
            <td style="border: 1px solid #ccc; padding: 0.5rem; text-align: right; font-weight: 600; color: #b87333;">+ $${formatCurrency(e.amount_usd)}</td>
          </tr>
        `).join('')}
    ...
    <!-- Detalle de Pagos -->
    <h3 style="font-size: 16px; font-weight: bold; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem; margin-bottom: 1rem;">1. HISTORIAL DE PAGOS RECIBIDOS</h3>
    ...
    <!-- Detalle de Gastos -->
    <h3 style="font-size: 16px; font-weight: bold; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem; margin-bottom: 1rem;">2. RELACIÓN DE GASTOS EJECUTADOS</h3>
    ${printCosts.length === 0 ? `
    ...
    <h3 style="font-size: 16px; font-weight: bold; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem; margin-bottom: 1rem;">3. CUENTAS POR PAGAR (PENDIENTES)</h3>
    ...
    <!-- Detalle de Retiros -->
    <h3 style="font-size: 16px; font-weight: bold; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem; margin-bottom: 1rem;">4. RETIRO DE SOCIOS</h3>
